...
<div style="background-color:gray; color:white; padding:3px;  -moz-border-radius: 5px; -webkit-border-radius: 5px; font-size:16px;"><strong><i>M</i>enu</strong>&nbsp;&nbsp;<a href="gestion.php"><img height="40" width="30" src="images/house.gif" alt="Accueil" /></a></div>
	...
	<div id="contenu1"> 
		<div class="menu a">
		<span class="menutop"><a href="">&nbsp;&nbsp;<strong>Ajouter un service</strong>&nbsp;&nbsp;</a></span>&nbsp;|
		<span class="menutop"><a href="">&nbsp;&nbsp;<strong>Liste des services</strong>&nbsp;&nbsp;</a></span>
		</div>
	...
	<div id="pied" >
		D&eacute;v&eacute;lopp&eacute;e par InfoSoft<br />Copyright@InfoSoft 2013. Tout droit reserv&eacute;
	</div>
</div>
</body>
</html>
